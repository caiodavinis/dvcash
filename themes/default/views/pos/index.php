...
<body class="skin-black sidebar-collapse sidebar-mini pos">
	<div class="wrapper">
						...
						<div class="row">
							...
							<div class="col-xs-5">
								<div class="form-group">
									...
									<select name="paid_by[]" class="form-control paid_by select2" style="width:100%;">
							...
							<div class="col-xs-6">
								<div class="form-group">
									<?= lang("amount", "amount"); ?>
									<input name="amount[]" type="text" class="pa form-control kb-pad amount" autofocus />
								</div>
							</div>
							<div class="col-xs-1">
								<div class="form-group">
                                                                    <p class="adicionarPgto">+</p>
								</div>
							</div>
                                                    <span id="retornaHtml"></span>
...
<!--				<div class="col-xs-3 text-center">
		...
		<div class="modal-footer">
			<button type="button" class="btn btn-default pull-left" data-dismiss="modal"> <?=lang('close')?> </button>
                        <button class="btn btn-primary" disabled id="<?= $eid ? '' : 'submit-sale'; ?>"><?=lang('submit')?></button>
		</div>
	</div>
</div>
</div>
