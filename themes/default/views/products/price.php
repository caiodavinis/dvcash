...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#fileData').dataTable( {
            ...
            'sAjaxSource': '<?= site_url('products/get_products_price') ?>',
            ...
            "aoColumns": [null, null,  {"mRender":currencyFormat}]
        });
        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title">Relatório de Preço: <?=date('d/m/Y h:m:s')?></h3>
                </div>
                <div class="box-body">
                        ...
                        <table id="fileData" class="table table-striped table-bordered table-hover" style="margin-bottom:5px;">
                            ...
                            <tr class="active">
                                ...
                                <th style="width: 20%"><?= lang("price"); ?></th>
                            </tr>
                            </thead>
                            <tbody>
                            <tr>
