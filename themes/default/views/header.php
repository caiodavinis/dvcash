...
<body class="skin-black fixed sidebar-mini">
<div class="wrapper">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview mm_products">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li id="products_print_labels"><a onclick="window.open('<?= site_url('products/stock'); ?>', 'pos_popup', 'width=900,height=600,menubar=yes,scrollbars=yes,status=no,resizable=yes,screenx=0,screeny=0'); return false;"
                                        href="#"><i class="fa fa-circle-o"></i>Imprimir Estoque</a></li>
                        <li id="products_print_labels"><a onclick="window.open('<?= site_url('products/price'); ?>', 'pos_popup', 'width=900,height=600,menubar=yes,scrollbars=yes,status=no,resizable=yes,screenx=0,screeny=0'); return false;"
                                        href="#"><i class="fa fa-circle-o"></i>Imprimir Preços</a></li>
                        <li id="products_print_labels"><a onclick="window.open('<?= site_url('products/pendent'); ?>', 'pos_popup', 'width=900,height=600,menubar=yes,scrollbars=yes,status=no,resizable=yes,screenx=0,screeny=0'); return false;"
                                        href="#"><i class="fa fa-circle-o"></i>Imprimir Pendencias</a></li>
