...
//            die;
            ...
            $pa = 0;
            $pag = 0;
            foreach($payment as $paymentI){
                unset($paymentI['cc_cvv2']);
                if($paymentI['paid_by'] === 'cash' && $pag === 0){
                    $pag++;
                }else{
                    unset($paymentI['pos_balance']);
                }
                
                $paymentI['sale_id'] = $sale_id;
                $paymentI['pos_paid'] = $paymentI['amount'];
                    $this->db->insert('payments', $paymentI);
//                    $pa++;
//                    echo '<pre>';
//                    print_r($paymentI);
//                    
